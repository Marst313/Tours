...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // validate: [validator.isAlpha, 'A name should be only strings'],
    },
    slug: String,
    duration: {
      type: Number,
    ...
    priceDiscount: {
      type: Number,
      //! only points to current NEW DOCUMENT creation
      validate: {
...
//! DOCUMENT MIDDLEWARE/PRE HOOK : run before .save() and .create
